...
g++ -o ColorRunner.exe src/Core/UI/*.o src/Core/Shader/*.o src/Core/*.o src/Game/*.o -I./build/include -L./build/lib/ -lglfw3 -lglew32 -lopengl32 -lglu32 -lgdi32 -lm -std=c++11